    ...
    <div className="space-y-12 pb-20">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {loading ? (
            <div className="col-span-2 p-12 text-center opacity-20 italic text-sm">
              Scanning Registry...
            </div>
          ) : mailboxes.length > 0 ? (
            mailboxes.map((box) => (
              <div
                key={box.id}
                className="group flex items-center justify-between p-4 bg-(--surface) border border-(--border-color) rounded-lg hover:border-(--text-main) transition-all"
              >
            ...
            <div className="col-span-2 p-12 border border-dashed border-(--border-color) rounded-2xl text-center">
